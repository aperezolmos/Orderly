...
public class ReservationRequestDTO {
    ...
    @Size(max = 100, message = "Guest's first name cannot exceed 100 characters")
    private String guestFirstName;

    @NotBlank(message = "Guest's last name is required")
    @Size(max = 100, message = "Guest's last name cannot exceed 100 characters")
    private String guestLastName;

    @NotBlank(message = "Guest's phone is required")
    @Size(max = 100, message = "Guest's phone cannot exceed 100 characters")
    private String guestPhone;

    @Size(max = 500, message = "Guest's special requests cannot exceed 500 characters")
