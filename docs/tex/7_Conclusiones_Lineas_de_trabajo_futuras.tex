...
\begin{itemize}
	...
	\item \textbf{Calidad de \textit{software}:} ampliación de la cobertura de pruebas unitarias e integración de pruebas de extremo a extremo (E2E) para el \textit{frontend}.
\end{itemize}
...
En definitiva, \textit{Orderly} se posiciona como una solución versátil que puede \textbf{evolucionar} desde una herramienta interna de gestión hasta convertirse en una plataforma integral que conecte a trabajadores y clientes bajo un \textbf{ecosistema digital común}.
