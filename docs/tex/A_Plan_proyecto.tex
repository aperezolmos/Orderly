...
\begin{itemize}
	\item \textbf{Creación del proyecto \textit{Spring Boot}:} se configuró un proyecto base con las dependencias listadas en el apartado <agregar ref>\todo{Agregar ref de apartado dependencias}.
