...
Al iniciar sesión con credenciales válidas, se redirigirá al usuario a su página de inicio.
...
\missingfigure{Imagen página listado}
...
\missingfigure{Imagen página crear}
...
\missingfigure{Imagen página editar}
...
\missingfigure{Imagen modal eliminar}
...
\missingfigure{Imagen sección info básica con lista de alérgenos desplegada}
...
\missingfigure{Imagen sección nutricional gráfico}
...
\missingfigure{Ingredientes con nova y nutriscore. Algunos que lo tengan calculado y otros no}
...
\missingfigure{Imagen campos nutricionales formulario}
...
\missingfigure{Imagen checkboxes alérgenos}
...
\missingfigure{Imagen transfer list roles}
...
\missingfigure{Imagen checkboxes permisos}
