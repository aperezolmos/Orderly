...
%	\setlength{\parsep}{0pt}
	...
	\item \textbf{Establecer un flujo de Integración Continua (CI)}: configurar un \textit{workflow} con \textit{GitHub Actions} que automatice la ejecución de pruebas e integre el análisis de código con \textit{SonarCloud} para monitorizar métricas de calidad, seguridad y fiabilidad de forma continua.
