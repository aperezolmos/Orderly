...
\imagenConEtiqueta[0.8\textwidth]{img/apdo_3/3_alergenos.png}{Catorce alérgenos de declaración obligatoria de la UE}{3_alergenos}\todo{Referencia o elaborar mi propia imagen}
