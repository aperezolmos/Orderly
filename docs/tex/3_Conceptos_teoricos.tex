...
\imagenConEtiqueta[0.8\textwidth]{img/apdo_3/3_nutriscore.png}{Etiquetas A-E según Nutri-Score}{3_nutriscore}
...
\imagenConEtiqueta[0.5\textwidth]{img/apdo_3/3_nova.png}{Etiquetas 1-4 según clasificación NOVA}{3_nova}
...
\imagenConEtiqueta[0.8\textwidth]{img/apdo_3/3_alergenos.png}{14 alérgenos de declaración obligatoria de la UE}{3_alergenos}
