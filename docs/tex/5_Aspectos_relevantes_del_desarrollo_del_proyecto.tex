...
\vspace{-15pt}
\imagenConEtiqueta[0.47\textwidth]{img/apdo_5/5_modeloEER_Completo.png}{Modelo de base de datos actual}{5_modeloEER_Completo}\todo{Queda pendiente actualizarlo con los campos de alérgenos}
...
La comunicación con \textit{OFF} se basa en una \textbf{primera fase} de búsqueda y selección de un alimento mediante \textit{React}, complementada por una \textbf{segunda fase} de petición de información detallada de dicho alimento y posterior adaptación al modelo de datos por parte de \textit{Spring Boot}. Las equivalencias entre campos del modelo y datos de \textit{OFF} se han centralizado en un \textit{mapper} específico (\texttt{OpenFoodFactsMapper}).
