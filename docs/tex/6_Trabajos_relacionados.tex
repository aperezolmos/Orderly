...
Con el objetivo de situar este trabajo en el panorama descrito, se describirá a continuación una aplicación representativa de cada rama. Posteriormente se mostrará una tabla comparativa (ver tabla \ref{tab:6_comparativa_apps}) entre las funcionalidades características de las aplicaciones presentadas y las de \revisionA{NombreApp}\todo{cambiar}.
...
\begin{table}[ht]
	...
	\begin{scriptsize}
		...
		\begin{tabularx}{\textwidth}{ L | C | C | C | C }
			...
			\textbf{Funcionalidad} & \textbf{NutriMenu} & \textbf{Floreant} & \textbf{MenuCalc} & \textbf{NombreApp} \\
