...
\todo[inline]{Tablas que detallen cada atributo de cada clase (nombre, tipo de dato, descripción)???? o mencionar algún atributo relevante al menos}
\todo[inline]{Relación IS-A en el diagrama -> editar}

\subsection{Modelo conceptual}
\label{subsec:C.2_ModeloConceptual}
...
Cabe destacar que todas las entidades disponen de campos de auditoría (\texttt{createdAt} y \texttt{updatedAt}) para rastrear automáticamente la creación y última modificación de cada registro.\todo{mencionar aquí o en 5. Aspectos relevantes?} %...con el objetivo de...?

\imagenConEtiqueta[0.8\textwidth]{img/apen_C/C2_modeloEER_Conceptual.png}{Diagrama EER conceptual}{C2_modeloEER_Conceptual}

La figura \ref{fig:C2_modeloEER_Conceptual} muestra el diagrama Entidad-Relación conceptual, el cual solo muestra las relaciones y atributos principales (PKs y FKs) del modelo para una mayor claridad y simplificación.
...
Para facilitar la comprensión del modelo de datos, se presentan distintos diagramas Entidad-Relación que agrupan los módulos funcionales según su interdependencia.

\subsubsection{Modelo para gestión de usuarios y roles}

\imagenConEtiqueta[0.7\textwidth]{img/apen_C/C2_modeloEER_Usuarios.png}{Diagrama EER para módulo de usuarios y roles}{C2_modeloEER_Usuarios}

Este módulo, cuyo esquema se detalla en la figura \ref{fig:C2_modeloEER_Usuarios}, controla el acceso al sistema y los permisos del personal del restaurante. Las relaciones involucradas son:
...
\imagenConEtiqueta[0.6\textwidth]{img/apen_C/C2_modeloEER_Productos.png}{Diagrama EER para módulo de alimentos y productos}{C2_modeloEER_Productos}

Este módulo, cuyo esquema se detalla en la figura \ref{fig:C2_modeloEER_Productos}, gestiona el catálogo de productos del restaurante y su composición en ingredientes, permitiendo calcular información nutricional automáticamente. Las relaciones involucradas son:
...
\imagenConEtiqueta[0.7\textwidth]{img/apen_C/C2_modeloEER_Pedidos.png}{Diagrama EER para módulo de pedidos}{C2_modeloEER_Pedidos}
...
y los motivos de su elección, así como una descripción más detallada de los tipos de pedido, se pueden encontrar en el \textit{pull request} \href{https://github.com/aperezolmos/tfg-aperezolmos/pull/80}{\#80}.
