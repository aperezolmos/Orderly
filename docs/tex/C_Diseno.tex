...
A continuación, se procede a listar las \textbf{entidades} que conforman la aplicación y a describir brevemente su propósito. %Las relaciones se describirán en...<ref modelos detallados>?
...
\imagenConEtiqueta{img/apen_C/C2_modeloEER_Usuarios.png}{Diagrama EER para módulo de usuarios y roles}{C2_modeloEER_Conceptual}
