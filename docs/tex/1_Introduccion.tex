...
El sector de la restauración es un entorno dinámico y complejo donde la eficiencia operativa es un factor clave para el éxito. Tradicionalmente, la gestión de estos establecimientos ha dependido de una combinación de herramientas dispersas (desde registros manuales hasta \textit{software} especializado a menudo cerrado y poco adaptable) que no siempre se comunican entre sí. Esta fragmentación de procesos aumenta la complejidad operativa y el margen de error, dificultando el flujo de trabajo entre cocina y sala.
...
El reporte de calidad del código realizado por \textit{SonarCloud} puede visualizarse en:
